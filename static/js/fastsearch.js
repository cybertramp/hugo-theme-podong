...
document.addEventListener('keydown', function(event) {
  ...
  if (event.metaKey && event.key === 191) {
      ...
      if (!searchVisible) {
        document.getElementById("searchBox").style.visibility = "visible"; // show search box
        document.getElementById("searchInput").focus(); // put focus in input box so you can just start typing
        searchVisible = true; // search visible
      }
      else {
        document.getElementById("searchBox").style.visibility = "hidden"; // hide search box
